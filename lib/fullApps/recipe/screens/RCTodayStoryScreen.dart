  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Stack(children: [
          ...
          Positioned(top: 24, left: 16,child: RCBackComponent(color: Colors.white, borderColor: Colors.white)),
          Positioned(
            top: 150,
            left: 16,
            child: Column(
              ...
              children: [
                ...
                Row(
                    ...
                    children: [
                      Text('Story', style: boldTextStyle(size: 30, fontFamily: GoogleFonts.playfairDisplay().fontFamily, color: Colors.white)), 16.width,
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                            ...
                            ClipPath(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [Icon(LineIcons.bookmark, color: rcSecondaryTextColor), 4.width, Text('Save', style: secondaryTextStyle(weight: FontWeight.bold, color: rcSecondaryTextColor))],
                                ),
                              ).onTap(() {
