                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Salad',style: secondaryTextStyle(color: salad ? primaryColor : rcSecondaryTextColor ),).center(),
                          ],
                        ),
                      ).onTap((){
                        salad = !salad;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Sandwich',style: secondaryTextStyle(color: sandwich ? primaryColor : rcSecondaryTextColor ),).center(),
                          ],
                        ),
                      ).onTap((){
                        sandwich = !sandwich;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Spring',style: secondaryTextStyle(color: spring ? primaryColor : rcSecondaryTextColor ),).center(),
                          ],
                        ),
                      ).onTap((){
                        spring = !spring;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Sushi',style: secondaryTextStyle(color: sushi ? primaryColor : rcSecondaryTextColor ),).center(),
                          ],
                        ),
                      ).onTap((){
                        sushi = !sushi;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Pizza',style: secondaryTextStyle(color: pizza ? primaryColor : rcSecondaryTextColor ),).center(),
                          ],
                        ),
                      ).onTap((){
                        pizza = !pizza;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Noodles',style: secondaryTextStyle(color: noodles ? primaryColor : rcSecondaryTextColor ),).center(),
                          ],
                        ),
                      ).onTap((){
                        noodles = !noodles;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Chinese',style: secondaryTextStyle(color: chinese ? primaryColor : rcSecondaryTextColor ),).center(),
                          ],
                        ),
                      ).onTap((){
                        chinese = !chinese;
