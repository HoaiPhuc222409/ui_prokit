      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            16.height,
            RCCommentComponent(name: 'Anita Rose',comment: 'Wow! amazing',time: '3 mins',likes: '139',showLikes: false,liked: false,path : 'images/recipe/faceOne.jpg').onTap((){
              RCCommentScreen().launch(context);
            }),
            Divider(height: 50),
            RCCommentComponent(name: 'Melanis',comment: 'Beautiful, I\'ll like to see what good he has to offer me',time: '3 mins',likes: '29',showLikes: false,liked: false,path : 'images/recipe/faceThree.jpg').onTap((){
              RCCommentScreen().launch(context);
            }),
            30.height,
