    ...
    return Container(
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            30.height,
            Text('Good Morning,', style: boldTextStyle(size: 30, fontFamily: GoogleFonts.playfairDisplay().fontFamily)).paddingSymmetric(horizontal: 16),
            Text('${widget.name} !', style: boldTextStyle(size: 30, fontFamily: GoogleFonts.playfairDisplay().fontFamily)).paddingSymmetric(horizontal: 16),
            16.height,
            Text('Would you consider a solely plant-based out of climate change reasons?', style: secondaryTextStyle(color: rcSecondaryTextColor)).paddingSymmetric(horizontal: 16),
            16.height,
            Wrap(
              runSpacing: 8,
              spacing: 16,
                ...
                Container(
                  child: Stack(
                    children: [
                      ClipPath(
                        ...
                        child: Container(
                            ...
                            child: Align(
                              ...
                              child: Text('Yes', style: boldTextStyle(color: !no ? Colors.white : rcSecondaryTextColor),).paddingOnly(bottom: 8),
                            )
                      ...
                      Positioned(
                        top: 8,
                        child: Image.asset('images/recipe/leonardo.png', height: 130,),
                      )
                    ],
                  ),
                ).onTap(() {
                    ...
                    children: [
                      ClipPath(
                        ...
                        child: Container(
                            ...
                            child: Align(
                              alignment: Alignment.bottomCenter,
                              child: Text('No', style: boldTextStyle(color: no ? Colors.white : rcSecondaryTextColor),).paddingOnly(bottom: 8),
                            )
