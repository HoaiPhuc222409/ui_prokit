...
List<MIAMealModel> getMealList() {
  ...
  list.add(MIAMealModel(image: 'images/mealime/plate_one.jpg', text: 'Brussels Sprouts, Mashed Potatoes & Sausage Bowl with sugar', added: false, pro: true));
  list.add(MIAMealModel(image: 'images/mealime/plate_two.jpg', text: 'Roasted Cauliflower & Black Bean Burrito Bowl with Cilantro Lights', added: false, pro: false));
  list.add(MIAMealModel(image: 'images/mealime/plate_three.jpg', text: 'Creamy Cashew Zucchini Noodles with Vegan Sausage, Article', added: false, pro: false));
  list.add(MIAMealModel(image: 'images/mealime/plate_four.jpg', text: 'Lebanese Lentils, Rice & fried Onions (Mujadara) with Chocolate', added: false, pro: true));
  list.add(MIAMealModel(image: 'images/mealime/plate_five.jpg', text: 'Brussels Sprouts, Mashed Potatoes & Sausage Bowl with sugar', added: false, pro: false));
...
List<MIASelectOptionsModel> getShopsList(){
  ...
  list.add(MIASelectOptionsModel(title: 'Asda', subtitle: 'images/mealime/asda.png',selected: false));
  list.add(MIASelectOptionsModel(title: 'Ocado', subtitle: 'images/mealime/ocado.png',selected: false));
  list.add(MIASelectOptionsModel(title: 'Tesco', subtitle: 'images/mealime/tesco.png',selected: false));
...
List<MIADashboardModel> getSettingsList() {
  ...
  list.add(MIADashboardModel(image: 'images/mealime/adjust.png', tab: 'Eating Preferences'));
  list.add(MIADashboardModel(image: 'images/mealime/book.png', tab: 'Your recipes'));
  list.add(MIADashboardModel(image: 'images/mealime/gift.png', tab: 'Share Mealime'));
  list.add(MIADashboardModel(image: 'images/mealime/chef.png', tab: 'Meet Our Chefs'));
  list.add(MIADashboardModel(image: 'images/mealime/bulb.png', tab: 'Help Make Mealime Better'));
