    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: !widget.image.isEmptyOrNull ? AssetImage(widget.image.validate()) : AssetImage('images/beauty_master/face_three.png'), fit: BoxFit.cover),
        ),
        child: Column(
          ...
          children: [
            Image.asset(
              'images/beauty_master/face_two.jpg',
              height: 150,
              width: 110,
              fit: BoxFit.cover,
