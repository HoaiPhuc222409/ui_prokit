...
List<BMMasterModel> getMyMastersList() {
  ...
  list.add(BMMasterModel(image: 'images/beauty_master/face_two.jpg', name: 'Hannah Benson'));
  list.add(BMMasterModel(image: 'images/beauty_master/face_one.png', name: 'Maurice Reynolds'));
  list.add(BMMasterModel(image: 'images/beauty_master/model_three.jpg', name: 'Hannah Benson'));
...
List<BMMasterModel> getTopServicesHomeList() {
  ...
  list.add(BMMasterModel(image: 'images/beauty_master/salon.png', name: 'Hair Salon'));
  list.add(BMMasterModel(image: 'images/beauty_master/nail-polish.png', name: 'Nail Salon'));
  list.add(BMMasterModel(image: 'images/beauty_master/makeup.png', name: 'Beauty Salon'));
  list.add(BMMasterModel(image: 'images/beauty_master/makeup_kit.png', name: 'Beauty Salon'));
...
List<BMCommonCardModel> getSpecialOffersList() {
  ...
  list.add(BMCommonCardModel(
    ...
    image: 'images/beauty_master/salon_one.jpg',
    saveTag: true,
  ...
  list.add(BMCommonCardModel(
    title: 'Paul Cuts',
    image: 'images/beauty_master/salon_two.jpg',
    saveTag: true,
    subtitle: '131-18 Merrick Blvd, Jamaica,Ny 11434',
    rating: '4.9',
  ...
  list.add(BMCommonCardModel(
    ...
    image: 'images/beauty_master/salon_four.jpg',
    saveTag: true,
  ...
  list.add(BMCommonCardModel(
    title: 'Savanna',
    image: 'images/beauty_master/salon_three.jpg',
    saveTag: true,
...
List<BMCommentModel> getCommentsList() {
  ...
  list.add(BMCommentModel(image: 'images/beauty_master/face_one.png', likes: '4', time: '3m', name: 'Donald Walters', message: 'Nice work, bro!', isSubComment: false, isLiked: false));
  list.add(BMCommentModel(image: 'images/beauty_master/face_two.jpg', likes: '2', time: '3m', name: 'Roxie Love', message: 'How many time for this style?', isSubComment: false, isLiked: true));
  list.add(BMCommentModel(image: 'images/beauty_master/face_one.png', likes: '2', time: '3m', name: 'Cotherine Guzman', message: '45 minutes. maybe.', isSubComment: true, isLiked: false));
  list.add(BMCommentModel(image: 'images/beauty_master/face_two.jpg', likes: '4', time: '20m', name: 'Nwaye Akachi', message: 'Good work!', isSubComment: false, isLiked: false));
  list.add(BMCommentModel(image: 'images/beauty_master/face_one.png', likes: '4', time: '2d', name: 'Cvita Dolwschall', message: 'Suite with me, let\'s go!', isSubComment: false, isLiked: false));
...
List<BMAppointmentModel> getAppointments() {
  ...
  list.add(BMAppointmentModel(
    image: 'images/beauty_master/face_one.png',
...
List<BMAppointmentModel> getMoreAppointmentsList() {
  ...
  list.add(BMAppointmentModel(
    image: 'images/beauty_master/face_two.jpg',
...
List<BMMessageModel> getActiveList() {
  ...
  list.add(BMMessageModel(image: 'images/beauty_master/face_two.jpg', name: 'Hannah Benson', message: 'Hello!', isActive: true, lastSeen: ''));
  list.add(BMMessageModel(image: 'images/beauty_master/face_two.jpg', name: 'Harry Gardner', message: 'How can I help you?', isActive: true, lastSeen: ''));
...
List<BMMessageModel> getMessageList() {
  ...
  list.add(BMMessageModel(image: 'images/beauty_master/face_two.jpg', name: 'Hannah Benson', message: 'Hello!', isActive: true, lastSeen: ''));
  list.add(BMMessageModel(image: 'images/beauty_master/face_one.png', name: 'Victor Pocheco', message: 'Do you want to confirm yor appointment?', isActive: false, lastSeen: 'today , at 11:30 am'));
  list.add(BMMessageModel(image: 'images/beauty_master/model_three.jpg', name: 'Harry Gardner', message: 'How can I help you?', isActive: true, lastSeen: ''));
...
List<BMShoppingModel> getProductList() {
  ...
  list.add(BMShoppingModel(
    ...
    image: 'images/beauty_master/product_one.jpg',
    cost: '\$35.00',
    isAdded: true,
    items: 1,
    mrp: '\$40.29',
  ...
  list.add(BMShoppingModel(
    ...
    image: 'images/beauty_master/product_two.png',
    cost: '\$29.99',
    isAdded: false,
    items: 1,
    mrp: '\$35.00',
  ...
  list.add(BMShoppingModel(
    name: 'Intensive Theraphy Choco Gotas Shine',
    image: 'images/beauty_master/product_three.jpg',
    cost: '\$35.00',
    isAdded: false,
    items: 1,
    mrp: '\$40.29',
