...
ProTheme getFullApps() {
  ...
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'SocialV', tag: 'New', widget: SVSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Beauty Master', tag: '', widget: BMSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Laundry Service app', tag: '', widget: LSWalkThroughScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Mealime App', tag: '', widget: MIASplashScreen(), darkThemeSupported: true));
  ...
  list.add(ProTheme(name: 'Sneaker Shopping App', tag: '', widget: SSSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Smart Home', tag: '', widget: SHSplashScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Wallet App', tag: '', widget: WASplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Event App', tag: '', widget: EASplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'MediLab', tag: '', widget: MLSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Dating App', tag: '', widget: DASplashScreen(), darkThemeSupported: true));
  ...
  list.add(ProTheme(name: 'Flix App', type: '', widget: MuviSplashScreen(), darkThemeSupported: true));
